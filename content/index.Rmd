...
- **Aula 01** - 30/01: Intrudução ao R, Rstudio e `tidyverse`
- **Aula 02** - 01/02: Manipulação de vetores
- **Aula 03** - 03/02: Manipulação de dados com `dplyr` e `tidyr`
- **Aula 04** - 06/02: Visualização com `ggplot2`
- **Aula 05** - 08/02: Programação funcional com `purrr`
- **Aula 06** - 10/02: Introdução a Modelagem usando o R
